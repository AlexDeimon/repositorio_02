 ...
 * @author Paula
 */
public class VentanaObra extends javax.swing.JFrame {
    ...
    private void buscarPorId() {
        ...
        if(optionalObra.isPresent()){
            ...
            lbNotificaciones.setText(
                    "La obra que ud busca es: " + tfNombre.getText());
        }
        else{
    ...
    private Obra obtenerDatosDeFormulario(){
        Obra obra = new Obra();
        obra.setObrId(Long.parseLong(tfId.getText()));
    ...
    private void crear() {
        ...
        try{
            ...
            respuesta.append(obra.getObrNombre()); //
    ...
    public void eliminar(){
        ...
        try{
            ...
            lbNotificaciones.setText("Se eliminó la obra con id: " + id.toString());
        }
        catch(Exception e)
        {
