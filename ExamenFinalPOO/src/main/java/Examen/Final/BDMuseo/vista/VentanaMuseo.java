...
public class VentanaMuseo extends javax.swing.JFrame {
    ...
    MuseoRepositorio museoRepositorio;
    /**
    ...
    public VentanaMuseo() {
        ...
        museoRepositorio=SpringContext.getBean(MuseoRepositorio.class);
    }
    ...
    private void initComponents() {
        ...
        btConsultar.setText("Consultar museo por id");
...
public void limpiarCamposParaCreacion(){
    ...
    private void buscarPorId() {
        ...
        Optional<Museo> optionalMuseo = museoRepositorio.findById(id);
        if(optionalMuseo.isPresent()){
            Museo museo = optionalMuseo.get();
            tfNombre.setText(museo.getMusNombre());
            
            lbNotificaciones.setText(
                    "El museo que ud busca es: " + tfNombre.getText());
        }
        else{
            // Error cuando no existe el id
            lbNotificaciones.setText(
                    "El museo con id: " + tfId.getText() + 
                            " no existe en la base de datos");
        }
    }

    private Museo obtenerDatosDeFormulario(){
        Museo museo = new Museo();
        museo.setMusId(Long.parseLong(tfId.getText()));
        museo.setMusNombre(tfNombre.getText());
        return museo;
    }
    
    private void crear() {
        Museo museo = obtenerDatosDeFormulario();
        
        Long id = Long.parseLong(tfId.getText());
        Optional<Museo> optionalMuseo = museoRepositorio.findById(id);
        StringBuffer respuesta = new StringBuffer();
        if(optionalMuseo.isPresent()){
            respuesta.append("Se actualizó el museo: ");
        }
        else{
            respuesta.append("Se creó el museo: ");
        }
        museo.setMusId(id);
                
        try{
            museoRepositorio.save(museo); // Grabeme el museo obtenido del formulario
            respuesta.append(museo.getMusNombre()); //
            tfId.setText(museo.getMusId().toString());
    ...
    public void eliminar(){
        ...
        try{
            ...
            lbNotificaciones.setText("Se eliminó el museo con id: " + id.toString());
        }
        catch(Exception e)
        {
